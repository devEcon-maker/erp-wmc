...
<head>
    ...
    <title>Acces refuse - ERP WMC</title>
...
<body class="bg-background-dark min-h-screen">
    <div class="flex min-h-screen w-full flex-row">
        ...
        <div class="hidden lg:flex lg:w-1/2 xl:w-7/12 relative flex-col justify-end p-12 overflow-hidden bg-surface-dark">
            ...
            <!-- Overlay Gradient -->
            <div
                class="absolute inset-0 z-10 bg-gradient-to-t from-background-dark via-background-dark/80 to-red-500/20 mix-blend-multiply">
            </div>
            <div class="absolute inset-0 z-10 bg-black/40"></div>
            <!-- Content -->
            <div class="relative z-20 max-w-2xl">
                <div
                    class="mb-6 h-12 w-12 rounded-lg bg-red-500 flex items-center justify-center shadow-lg shadow-red-900/20">
                    <span class="material-symbols-outlined text-white text-3xl">shield</span>
                </div>
                <h1 class="text-white text-4xl font-bold leading-tight mb-4 tracking-tight">Acces securise requis.</h1>
                <p class="text-text-muted text-lg leading-relaxed max-w-lg">
                    Cette zone necessite des permissions specifiques. Contactez votre administrateur si vous pensez que c'est une erreur.
                </p>
            </div>
        </div>
        ...
        <div
            ...
            <div class="w-full max-w-[480px] flex flex-col gap-8 items-center text-center">
                ...
                <div class="lg:hidden mb-4 flex justify-center">
                    <div class="h-12 w-12 rounded-lg bg-red-500 flex items-center justify-center shadow-lg">
                        <span class="material-symbols-outlined text-white text-3xl">shield</span>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="text-[150px] sm:text-[200px] font-black text-red-500/10 leading-none select-none">
                        403
                    </div>
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="p-6 bg-red-500/20 rounded-full">
                            <span class="material-symbols-outlined text-red-500 text-6xl sm:text-7xl">block</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Info Box -->
                <div class="w-full bg-red-50 dark:bg-red-500/10 border border-red-200 dark:border-red-500/30 rounded-lg p-4">
                    <div class="flex items-start gap-3">
                        <span class="material-symbols-outlined text-red-500 text-xl mt-0.5">info</span>
                        <div class="text-sm text-red-700 dark:text-red-400 text-left">
                            <p class="font-medium mb-1">Pourquoi je vois cette page ?</p>
                            <p class="text-red-600 dark:text-red-300">Votre role utilisateur ne dispose pas des droits d'acces a cette fonctionnalite. Seuls les administrateurs autorises peuvent y acceder.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full pt-6 border-t border-gray-300 dark:border-border-dark">
                    ...
                    <a href="mailto:admin@erp-wmc.com"
                ...
                <div class="flex items-center justify-center gap-2 mt-auto pt-8 opacity-60">
                    ...
                    <p class="text-xs text-gray-400 dark:text-text-muted text-center">
                        Protection des donnees securisee
                    </p>
                </div>
            </div>
        </div>
